# termux-proxy-scraper
    Termux Proxy Scraper by shinn - Fast fresh free HTTP/HTTPS/SOCKS4/SOCKS5 proxies. Interactive menu, separate downloads, updated sources (every 5 mins). 🚀
